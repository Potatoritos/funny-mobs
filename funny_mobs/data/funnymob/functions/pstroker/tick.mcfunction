...
execute if score @s pfm_psex_a1 matches 180 run execute as @a[distance=..40] at @s run function funnymob:pstroker/a1
...
execute if score @s pfm_psex_a2 matches 340 run tp @s @a[limit=1,sort=nearest,gamemode=creative]
...
execute if score @s pfm_psex_a2 matches 360 run execute as @a[distance=..8] at @s run function funnymob:pstroker/a2
...
execute if score @s pfm_psex_a2 matches 360..420 run execute as @a[distance=..8] at @s run function funnymob:pstroker/phase
execute if score @s pfm_psex_a2 matches 360.. run function funnymob:pstroker/phase
#execute if score @s pfm_psex_a2 matches 380 run function funnymob:pstroker/a2_explosion
