...
execute if score dragon_next_skill pfm_enderdragon_vars matches 1 in the_end as @e[type=ender_dragon,sort=arbitrary,limit=1] run function funnymob:enderdragon/stray_tower
