...
execute as @e[type=ender_dragon,tag=!pfm_scanned_edrag] run attribute @s generic.max_health modifier add 26f84540-fb96-442c-84a1-25e37920441d "dragon_hp_buff" 2.0 multiply_base
