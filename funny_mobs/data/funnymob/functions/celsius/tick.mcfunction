...
execute as @s[scores={pfm_mob_hp=..60},tag=!pfm_celsius_lowhp] run playsound minecraft:block.respawn_anchor.deplete neutral @a ~ ~ ~ 1.2 0.5
execute as @s[scores={pfm_mob_hp=..60},tag=!pfm_celsius_lowhp] run scoreboard players set @s pfm_celsius_p 0
execute as @s[scores={pfm_mob_hp=..60}] run tag @s add pfm_celsius_lowhp
...
execute if score @s pfm_celsius_p_n matches 1 run scoreboard players set @s pfm_celsius_p_s 261
...
execute as @s[scores={pfm_celsius_p=260..}] run playsound minecraft:block.respawn_anchor.charge neutral @a ~ ~ ~ 1.2 0.5
execute as @s[scores={pfm_celsius_p=260..}] run particle minecraft:heart ~ ~1 ~ 0.5 0.5 0.5 1 10 force
execute as @s[scores={pfm_celsius_p=260..}] run tag @s add pfm_update_disp_hp
execute as @s[scores={pfm_celsius_p=260..}] run execute store result entity @s Health int 1 run scoreboard players get 90 pfm_constants
