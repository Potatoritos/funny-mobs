...
execute as @s[type=shulker,tag=!scanned_boss,scores={pfm_mob_hp=30}] in the_end at @s run function funnymob:spawn/celsius
execute as @s[type=shulker,tag=!scanned_boss,scores={pfm_mob_hp=30}] in the_end at @s run function funnymob:spawn/statue
execute as @s[type=shulker,tag=!scanned_boss,scores={pfm_mob_hp=30}] in the_end at @s run function funnymob:spawn/psex
execute as @s[type=shulker,tag=!scanned_boss,scores={pfm_mob_hp=30}] in the_end run scoreboard players add celsius pfm_mobcount 1
execute as @s[type=shulker,tag=!scanned_boss,scores={pfm_mob_hp=30}] in the_end run tag @s add scanned_boss
