...
execute if score @s pfm_ln2_cooldown matches 1.. run title @s subtitle [{"text":"","color":"red"},{"score":{"name":"@s","objective":"pfm_ln2_cooldown_secs"}},{"text":"."},{"score":{"name":"@s","objective":"pfm_ln2_cooldown_dec"}},{"text":"s"}]
title @s title ""
