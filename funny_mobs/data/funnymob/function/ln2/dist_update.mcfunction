...
execute store result score @s pfm_ln2_posx run data get entity @s Pos[0] 100
execute store result score @s pfm_ln2_posy run data get entity @s Pos[1] 100
execute store result score @s pfm_ln2_posz run data get entity @s Pos[2] 100
