...
execute if score @s pfm_celsius_a1 matches 255 run function funnymob:celsius/arsonist_burn_effect
execute if score @s pfm_celsius_a1 matches 240..270 run function funnymob:celsius/arsonist_burn
execute if score @s pfm_celsius_a1 matches 270 run data merge entity @s {NoGravity:0b,NoAI:0b}
