...
execute if score @s pfm_celsius_a1 matches 301..380 run function funnymob:celsius/a2_burn 
# execute as @a[distance=..14] at @s run function funnymob:celsius/a2_burn
